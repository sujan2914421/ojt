                ...
                <div class="relative h-auto w-auto">
                    <form action="login.php" method="POST" class="relative h-auto w-full grid gap-8 form">
                        <div class="relative h-auto w-full grid gap-3">
                            <div class="relative h-auto w-full text-xl font-extrabold">Sign up</div>
                            <div class="relative h-auto w-full text-xs font-normal">Sign up to continue.</div>
                        </div>
                            <div class="relative h-auto w-full grid gap-4">
                                <div class="relative h-[40px] w-full border border-gray-200 rounded-md flex gap-2 overflow-hidden">
                                    ...
                                    <div class="relative h-full w-[calc(100%-40px)] flex items-center justify-center">
                                        <input type="text" name="username" id="username" class="logindetails relative h-full w-full outline-none text-xs bg-transparent" placeholder="username">
                                    </div>
                                </div>
                                <div class="relative h-[40px] w-full border border-gray-200 rounded-md flex gap-2 overflow-hidden">
                                    <div class="relative h-full w-[40px] flex items-center justify-center">
                                    ...
                                    <div class="relative h-full w-[calc(100%-40px)] flex items-center justify-center">
                                        <input type="email" name="email" id="email" class="logindetails relative h-full w-full outline-none text-xs bg-transparent" placeholder="email">
                                    </div>
                                </div>
                                <div class="relative h-[40px] w-full border border-gray-200 rounded-md flex gap-2 overflow-hidden">
                                    <div class="relative h-full w-[40px] flex items-center justify-center">
                            ...
                            <div class="relative h-auto w-full flex items-center justify-between">
                                <div class="relative h-auto w-auto text-xs font-normal">Already have an account??</div>
                                <div onclick="location.replace('http://localhost/ojt/forms/login.php')" class="relative h-auto w-auto text-xs font-semibold text-blue-500">Login</div>
                            </div>
                        </div>
                    </form>
                </div>
